  ...
  for (ii = 0; ii < inum; ii++) {
    ...
    for (jj = 0; jj < jnum; jj++) {
      ...
      if (rsq < cutsq[itype][jtype]) {
		...
		double radavg = (radi+radj)/2.;
        forceyukawa = a[itype][jtype] * radavg * screening; //Added scaling based on radius: the parameter A should be independent of particle size
